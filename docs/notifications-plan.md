...
const triggerTime = new Date(startTime.getTime() + schedule.hours _ 60 _ 60 \* 1000);
...
import _ as TaskManager from 'expo-task-manager';
import _ as BackgroundFetch from 'expo-background-fetch';
import { db } from '@/services/database';
...
const triggerTime = new Date(schedule.startDateTime).getTime() + (schedule.hours _ 60 _ 60 \* 1000);
