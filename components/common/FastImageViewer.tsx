...
import { Zoomable, ZoomableRef, ZOOM_TYPE } from '@likashefqet/react-native-image-zoom';
...
const FastImageViewerComponent: React.FC<FastImageViewerProps> = ({
  ...
  const getHeaderSubtitle = () => {
    ...
    if (getSubtitle) {
      ...
      return `${images[currentIndex].type} Photo ${currentIndex + 1} of ${images.length}`;
    } else {
      ...
      <SafeAreaProvider initialMetrics={initialWindowMetrics}>
        <GestureHandlerRootView style={{ flex: 1 }}>
          <View className='flex-1 bg-black'>
            ...
            <View style={[styles.viewerContainer, { width: viewerWidth, height: viewerHeight }]}>
