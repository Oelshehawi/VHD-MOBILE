          ...
          <View className='flex-row justify-between items-start'>
            <View className='flex-1'>
              ...
              <Text className='text-gray-500 dark:text-gray-400 mb-2'>
                {startTime} {'\u2022'} {schedule.assignedTechnicians ? 'Assigned' : 'Unassigned'}
              </Text>
              ...
              {showNotificationBadge && (
                <View className='mb-2 flex-row items-center bg-red-50 px-2 py-1 rounded-md'>
                  ...
                  <Text className='text-xs text-red-600 font-medium ml-1'>Technician Notes</Text>
                </View>
              )}
...
export function DailyAgenda({
          ...
          <View className='flex-row items-start gap-2'>
            ...
            <View className='flex-1'>
              ...
              <Text className='text-sm text-yellow-700 dark:text-yellow-300'>
                ...
                {severeWeatherJobs.length !== 1 ? 's' : ''} affected by adverse weather conditions
              </Text>
  ...
  return onDateChange ? <GestureDetector gesture={panGesture}>{content}</GestureDetector> : content;
}
