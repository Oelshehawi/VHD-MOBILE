                ...
                <View className="flex-1 p-4 flex flex-col gap-4">
                    ...
                    <View className="bg-gray-100 dark:bg-gray-800 rounded-lg p-4">
                        ...
                        <View className="flex flex-col gap-2">
                            ...
                            <Text className="text-gray-700 dark:text-gray-300">
                                • Confirm all work has been completed to my
                                satisfaction
                            </Text>
                            <Text className="text-gray-700 dark:text-gray-300">
                            ...
                            <Text className="text-gray-700 dark:text-gray-300">
                                • Understand this is a legally binding
                                electronic signature under the Electronic
                                Transactions Act of British Columbia
                            </Text>
                            <Text className="text-gray-700 dark:text-gray-300">
                                • Agree this signature carries the same weight
                                and legal effect as a handwritten signature
                            </Text>
                            <Text className="text-gray-700 dark:text-gray-300">
                                • Consent to using electronic signatures for
                                this transaction
                            </Text>
                        </View>
                    </View>
